...
SimpleForm.setup do |config|
  ...
  config.button_class = "btn btn-dark"
  ...
  config.wrappers :vertical_form, tag: "div", class: "form-group flex-fill pl-2 pr-2", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    b.use :html5
    b.use :placeholder
  ...
  # vertical file input
  config.wrappers :vertical_file, tag: "div", class: "form-group flex-fill pl-2 pr-2", error_class: "form-group-invalid", valid_class: "form-group-valid" do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
